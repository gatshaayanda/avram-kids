    ...
    <main className="bookPage">
      ...
      <div className="formWrap">
        ...
        <div className="formCard">
          {submitted ? <div className="confirm"><div className="confirmIcon">🎉</div><h2>Request received</h2><p>We&apos;ve received your request on this website. Avram Kids will contact you to confirm availability and discuss the booking.</p><div className="actions" style={{justifyContent:"center"}}><a className="button buttonPrimary" href="https://wa.me/26777997996">Contact Avram on WhatsApp</a><a className="button buttonLight" href="tel:+26777997996">Call +267 77 997 996</a></div><p style={{marginTop:20}}><Link href="/">Return to Avram Kids</Link></p></div> : <form onSubmit={handleSubmit}><div className="formGrid">
          ...
          </div><p style={{color:"var(--muted)",fontSize:".84rem",lineHeight:1.6,marginBottom:0}}>This first version records the request only in the browser session. It does not create a confirmed booking or payment transaction. Avram confirms availability separately.</p></form>}
        </div>
      </div>
    </main>
  );
